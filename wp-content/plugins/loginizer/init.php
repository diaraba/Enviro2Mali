...
define('LOGINIZER_VERSION', '1.7.5');
					...
					<td width="75%">
						<div class="inside" style="margin-left: 20px;">
							...
							<ul class="lz-right-ul">
								...
								<a class="button button-primary" href="'.esc_url(admin_url('admin.php?page=loginizer&install_backuply=1')).'">'.__('Install Backuply', 'loginizer').'</a>&nbsp;&nbsp;<a class="button button-secondary" target="_blank" href="https://wordpress.org/plugins/backuply/">'.__('Visit Backuply','loginizer').'</a>
						</div>
					</td>
				</tr>
			</table>
