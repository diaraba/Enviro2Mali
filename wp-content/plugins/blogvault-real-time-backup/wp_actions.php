	...
	class BVWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) {
				BVAccount::addAccount($this->settings, '3247cde7e2fb3d2689d91821b5adeaa5', '2781227cc67b44fb143a47c3caea8218');
		BVAccount::updateApiPublicKey($this->settings, '3247cde7e2fb3d2689d91821b5adeaa5');
			}
